...
- **Never edit `hello/` by hand.** It is a copy of `ardemo-studio/dist/`, see "Build & deploy" in the AR README.
...
- `/ardemo-deploy`: pre-flight checks, build and copy to `hello/`. Only on explicit request.
